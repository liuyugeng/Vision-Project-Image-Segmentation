...
class R2U_Net(nn.Module):
    def __init__(self, img_ch=3, output_ch=19, t=2):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes, training):
...
def DualSeg_res101(num_classes=19, training=False):
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_classes, training=training)
    return model


def DualSeg_res50(num_classes=19, training=False):
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes, training=training)
    return model